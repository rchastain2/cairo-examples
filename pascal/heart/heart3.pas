...
{
  La troisième procédure exploite le chemin avec un fill sur une source de couleur rouge mi-transparente, suivi d'un stroke sur une source de couleur bleue mi-transparente.
  Comme on souhaite garder le chemin actif après le fill pour le réutiliser avec un stroke, on utilise cairo_fill_preserve().
}
