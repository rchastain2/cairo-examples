...
{
  La huitième procédure fait la même chose mais ferme le chemin pour éliminer le problème précédent.
  Il n'y a plus d'extrémités, il n'y a plus que des jointures.
}
