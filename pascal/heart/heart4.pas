...
{
  La quatrième procédure exploite le chemin avec deux strokes d'épaisseurs 15 et 5 sur des source de couleurs mi-transparentes rouge et bleue.
  Comme on souhaite garder le chemin actif après le premier stroke pour le réutiliser avec le second stroke, on utilise cairo_stroke_preserve() la première fois.
}
