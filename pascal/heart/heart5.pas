...
{
  La cinquième procédure fait la même chose mais utilise des jointures (joins) arrondies et des extrémités (caps) arrondies.
  Un exemple de jointure se trouve en haut dans le creux du cœur, et les deux extrémités du chemin se trouvent en bas dans la pointe du cœur.
}
