...
begin
  ...
  MakeHeart(context, dw / 2, dh / 2, Min(dw, dh) / 3, 24);
{
  La septième procédure fait la même chose mais change l'écart d=0 en d=r/3 pour que la jointure pointue soit possible.
  On voit ici que le fait que le chemin ne soit pas fermé génère des extrémités carrées qui se croisent dans la pointe du cœur, créant un effet graphique disgracieux.
}
