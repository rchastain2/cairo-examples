...
begin
  ...
  cairo_arc(context, gx, gy, 2.5, 0, 2 * PI); cairo_fill(context);
  cairo_arc(context, x1, y1, 2.5, 0, 2 * PI); cairo_fill(context);
  cairo_arc(context, x2, y2, 2.5, 0, 2 * PI); cairo_fill(context);
  cairo_arc(context, x3, y3, 2.5, 0, 2 * PI); cairo_fill(context);
  gx := x3;
  gy := y3;
end;
...
begin
  ...
  cairo_set_source_rgb(context, 0.4, 0.0, 0.0);
