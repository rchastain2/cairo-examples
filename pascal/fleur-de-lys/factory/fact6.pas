...
begin
  ...
  //WriteLn(Format('cairo_line_to(context, %f, %f);', [fa, fb]));
  //WriteLn(Format('cairo_line_to(context, %f, %f);', [fc, fd]));
  //WriteLn(Format('cairo_line_to(context, %f, %f);', [fe, ff]));
  WriteLn(Format('  %6n, %6n, %6n, %6n, %6n, %6n,', [fa, fb, fc, fd, fe, ff]));
  ga := fe;
  gb := ff;
end;
