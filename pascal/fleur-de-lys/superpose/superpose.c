...
int main(int argc, char *argv[])
{
  ...
  width = cairo_image_surface_get_width(surf1);
  height = cairo_image_surface_get_height(surf1);
  
  cairo_surface_t *surf0 = cairo_image_surface_create(CAIRO_FORMAT_ARGB32, width, height);
