...
begin
  ...
  cairo_arc(context, gx, gy, R, 0, 2 * PI); cairo_fill(context);
  cairo_arc(context, x1, y1, R, 0, 2 * PI); cairo_fill(context);
  cairo_arc(context, x2, y2, R, 0, 2 * PI); cairo_fill(context);
  cairo_arc(context, x3, y3, R, 0, 2 * PI); cairo_fill(context);
