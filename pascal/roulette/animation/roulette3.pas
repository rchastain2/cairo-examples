...
{ Background color (simpler) }
  ...
  *)
  ...
  angle := StrToIntDef(ParamStr(1), 0);
  
  cairo_rotate(cr, DegToRad(-angle) + PI / 2 - PI / 36);
  ...
  cairo_surface_write_to_png(sf, pchar(Format(FMT, [angle])));
