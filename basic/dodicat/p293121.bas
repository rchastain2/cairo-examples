...
' https://www.freebasic.net/forum/viewtopic.php?p=293121#p293121
...
sub Cprint(surf as cairo_t ptr,x as long,y as long,text as string,size as single,colour as ulong)
    ...
    cairo_move_to (surf, x - _text.width / 2 - _text.x_bearing, y + _text.height / 2)
...
while 1
    ...
    draw string (50,190),"System status " & iif(status,"OK","Leaks")
